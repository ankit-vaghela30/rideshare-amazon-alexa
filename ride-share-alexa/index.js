...
var handlers = {
  ...
  'DriverOrRider': function () {
    ...
    this.emit(':ask', 'What is your source and destination?'); 
  ...
  var params = {
        ...
        documentClient.query(params, function(err, data) {
         ...
         else
         {
          ...
          searchResultMessage = "Here are your search results. "+ tempMessage+" Select any number. do you want me to repeat?";
